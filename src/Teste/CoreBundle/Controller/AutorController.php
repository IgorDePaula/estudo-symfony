...
namespace Teste\CoreBundle\Controller;
...
use Teste\ModelBundle\Entity\Autor;
use Teste\ModelBundle\Form\AutorType;
...
class AutorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TesteModelBundle:Autor')->findAll();
     ...
     * @Method("POST")
     * @Template("TesteCoreBundle:Autor:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesteModelBundle:Autor')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TesteModelBundle:Autor:edit.html.twig")
     */
